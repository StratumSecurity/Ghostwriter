...
LINTER_CONTEXT = {
    ...
    "project": {
        ...
        "start_time": "09:00:00",
        "end_time": "17:00:00",
        "chart_sdscore_appsec": "{{.chart_sdscore_appsec}}",
        "chart_sdscore_appsec_rt": "",
        "chart_sdscore_wireless": "{{.chart_sdscore_wireless}}",
        "chart_sdscore_wireless_rt": "",
        "chart_sdscore_external": "{{.chart_sdscore_external}}",
        "chart_sdscore_external_rt": "",
        "chart_sdscore_internal": "{{.chart_sdscore_internal}}",
        "chart_sdscore_internal_rt": "",
        "chart_sdscore_cloud": "{{.chart_sdscore_cloud}}",
        "chart_sdscore_cloud_rt": "",
        "chart_sdscore_physical": "{{.chart_sdscore_physical}}",
        "chart_sdscore_physical_rt": "",
        "chart_bar": "{{.chart_bar}}",
        "chart_bar_rt": "",
    ...
    "totals": {
        ...
        "sd_score_cloud": 1.3,
        "sd_score_appsec": 1.1,
        "sd_score_external": 1.2,
        "sd_score_internal": 1.4,
        "sd_score_physical": 1.5,
        "sd_score_wireless": 1.4,
        "chart_data": [["Authentication",0,0,1,0,1]],
        "chart_data_internal": [["Authentication",0,0,1,0,1]],
        "chart_data_external": [["Authentication",0,0,1,0,1]],
    },
